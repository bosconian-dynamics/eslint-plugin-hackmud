...
var create = exports.create = function create(context) {
  return {
    ...
    "ReturnStatement > FunctionExpression CallExpression Identifier[name=/^\\$S_.*/]": function ReturnStatementFunctionExpressionCallExpressionIdentifierName$S_(node) {
      while (node.type != 'CallExpression') {
        if (['Property', 'ObjectExpression'].includes(node.type)) return;
